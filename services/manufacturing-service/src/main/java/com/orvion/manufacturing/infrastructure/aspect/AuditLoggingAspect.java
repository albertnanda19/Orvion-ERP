package com.orvion.manufacturing.infrastructure.aspect;

import com.orvion.manufacturing.infrastructure.messaging.AuditEventPublisher;
...
public class AuditLoggingAspect {
    ...
    private static final String SERVICE_NAME = "orvion-manufacturing-service";
    ...
    @Around("execution(* com.orvion.manufacturing.presentation.controller.*.*(..))")
