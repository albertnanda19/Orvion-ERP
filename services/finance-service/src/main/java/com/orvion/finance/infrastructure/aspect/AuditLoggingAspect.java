package com.orvion.finance.infrastructure.aspect;

import com.orvion.finance.infrastructure.messaging.AuditEventPublisher;
...
public class AuditLoggingAspect {
    ...
    private static final String SERVICE_NAME = "orvion-finance-service";
    ...
    @Around("execution(* com.orvion.finance.presentation.controller.*.*(..))")
