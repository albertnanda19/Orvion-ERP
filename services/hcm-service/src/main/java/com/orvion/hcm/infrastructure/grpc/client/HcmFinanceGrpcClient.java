package com.orvion.hcm.infrastructure.grpc.client;
...
@Component
public class HcmFinanceGrpcClient {
    private static final Logger log = LoggerFactory.getLogger(HcmFinanceGrpcClient.class);
    private final ManagedChannel channel;
    private final FinanceServiceGrpc.FinanceServiceBlockingStub stub;

    public HcmFinanceGrpcClient() {
