package com.orvion.sales.infrastructure.aspect;

import com.orvion.sales.infrastructure.messaging.AuditEventPublisher;
...
public class AuditLoggingAspect {
    ...
    private static final String SERVICE_NAME = "orvion-sales-crm-service";
    ...
    @Around("execution(* com.orvion.sales.presentation.controller.*.*(..))")
