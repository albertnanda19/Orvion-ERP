package com.orvion.inventory.infrastructure.aspect;

import com.orvion.inventory.infrastructure.messaging.AuditEventPublisher;
...
public class AuditLoggingAspect {
    ...
    private static final String SERVICE_NAME = "orvion-inventory-service";
    ...
    @Around("execution(* com.orvion.inventory.presentation.controller.*.*(..))")
