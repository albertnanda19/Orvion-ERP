package com.orvion.notification.infrastructure.aspect;

import com.orvion.notification.infrastructure.messaging.AuditEventPublisher;
...
public class AuditLoggingAspect {
    ...
    private static final String SERVICE_NAME = "orvion-notification-service";
    ...
    @Around("execution(* com.orvion.notification.presentation.controller.*.*(..))")
